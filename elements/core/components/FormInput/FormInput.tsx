...
import { InputBorder, InputEffectWrapper, InputLabel, InputWrapper, StyledInput } from './FormInput.styles';
...
const FormInput=({label, type, name, ref}:FormInputProps)=>{
